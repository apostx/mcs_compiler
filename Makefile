...
$(DEST_DIR)$(DEST_NAME): $(SRC_DIR)$(SRC_NAME).cc $(SRC_DIR)lex.yy.cc $(SRC_DIR)parse.cc $(SRC_DIR)Parser.h $(SRC_DIR)Parser.ih
	g++ -o $(DEST_DIR)$(DEST_NAME) $(SRC_DIR)$(SRC_NAME).cc $(SRC_DIR)parse.cc $(SRC_DIR)lex.yy.cc
